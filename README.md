...
A minimal black-and-white design with clickable app project rows. The backtester and macro dashboard link directly to their Streamlit apps, with separate GitHub source links. The Goodreads project has a dedicated “View source on GitHub” link beneath its description. Fyre links to its live app, with a separate GitHub source link. Destinations were confirmed from the public project READMEs. The site uses system fonts and works without JavaScript or external font requests.
